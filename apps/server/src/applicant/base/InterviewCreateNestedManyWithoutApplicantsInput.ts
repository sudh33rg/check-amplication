...
@InputType()
class InterviewCreateNestedManyWithoutApplicantsInput {
...
export { InterviewCreateNestedManyWithoutApplicantsInput as InterviewCreateNestedManyWithoutApplicantsInput };
